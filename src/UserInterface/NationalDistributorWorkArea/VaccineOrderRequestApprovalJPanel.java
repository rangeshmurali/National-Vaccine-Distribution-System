...
import static Business.Organization.Organization.OrganizationType.Order;
...
public class VaccineOrderRequestApprovalJPanel extends javax.swing.JPanel {
    ...
    public VaccineOrderRequestApprovalJPanel(JPanel userProcessContainer, UserAccount userAccount, EcoSystem ecoSystem) {
        initComponents();
    ...
    public void populateVaccineOrderTable(){
        ...
        for(WorkRequest request : ecoSystem.getNationalDistributor().getWorkQueue().getWorkRequestList()){
